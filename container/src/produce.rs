...
pub async fn produce(
    ...
    println!("Messages sent = {}", futures.len());
    for future in futures {
        let completion = future.await;
        println!("Future completed. Result: {completion:?}");
    }
}

pub async fn produce_bill(
    brokers: &str,
    topic_name: &str,
    schema: &Schema,
    id: u32,
...
pub async fn produce_payment_request(
    brokers: &str,
    topic_name: &str,
    schema: &Schema,
    id: u32,
...
pub async fn produce_payment_failed(
    brokers: &str,
    topic_name: &str,
    schema: &Schema,
    id: u32,
